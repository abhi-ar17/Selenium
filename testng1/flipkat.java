...
public class flipkat {
  ...
  @Test
  public void d_search() throws InterruptedException
  {
  ...
  @Test
  public void f_continue() throws InterruptedException
  {
	  ArrayList<String> availableWindows = new ArrayList<String>(driver.getWindowHandles());
		 driver.switchTo().window(availableWindows.get(1)); 
		 driver.findElement(By.xpath("//*[@id=\"swatch-4-size\"]/a")).click();
		 Thread.sleep(2500l);
		 WebElement gh= driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[2]/div[1]/div[2]/div[4]/div[1]/div[1]/div/div[2]/div[1]"));
		 Actions act = new Actions(driver);
		 Action asd_ac = act
				 .moveToElement(gh)
				 .click()
		 ...
		 asd_ac.perform();
		 Thread.sleep(2500l);
		 WebElement ret = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[2]/div[1]/div[2]/div[4]/div[1]/div[1]/div/div[2]/div[2]/div[1]/div[1]"));
		 Action asd_act = act
				 .moveToElement(ret)
				 .click()
				 .build();
  ...
  public void g_final()
  {
	  ...
	  Action asd_a = act
		 ...
		 WebElement sdf = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[2]/div/div[1]/div[4]/div/div/div[1]/div/label[1]/div[2]/div/div/div[2]/button/span"));
		  Action asd_ab = act
					 .moveToElement(sdf)
					 .click()
					 .build();
